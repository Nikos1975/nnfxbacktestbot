...
if check_tentacle_version('1.2.0', 'dsl_realtime_evaluator', 'OctoBot-Default-Tentacles'):
    try:
        from .dsl_realtime_evaluator import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading dsl_realtime_evaluator: '
