...
if check_tentacle_version('1.2.0', 'sentiment_evaluator', 'OctoBot-Default-Tentacles'):
    try:
        from .sentiment_evaluator import *
    except Exception as e:
        get_logger('TentacleLoader').error(f'Error when loading sentiment_evaluator: '
