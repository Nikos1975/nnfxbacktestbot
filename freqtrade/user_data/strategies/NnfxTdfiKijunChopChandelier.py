...
class NnfxTdfiKijunChopChandelier(IStrategy):
    """
    TDFI proxy -> Kijun state, with CHOP filter and Chandelier exit.
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["kijun"] = self._kijun(dataframe)
        dataframe["chop"] = self._chop(dataframe)
