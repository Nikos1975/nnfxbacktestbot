...
class NnfxAlphaTrendRsxVoxiChandelier(IStrategy):
    """
    AlphaTrend proxy -> RSX proxy, with VOXI proxy and Chandelier exit.
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["alphatrend"] = self._alphatrend_proxy(dataframe)
        dataframe["rsx"] = self._rsx_proxy(close)
        ...
        dataframe["baseline_signal"] = close > dataframe["baseline"]
        ...
        dataframe["exit_signal"] = (close < dataframe["chandelier_long"]) | (dataframe["rsx"] < 45)
        return dataframe
